    ...
    const handleForgotPassword = async (): Promise<void> => {
        try {
            ...
            if (userDoc.exists()) {
                ...
                toast.error('No user found with this email. Please ensure you are registered with us.', {
                    position: 'bottom-center',
                });
            }
        } catch (error: any) {
            ...
            <div className='container1'>
                ...
                {action === 'Sign Up' ? <div></div> : (
                    <div className='forget-password'>
                        Forget password?<span onClick={handleForgotPassword}>Click Here!</span>
                    </div>
                )}
                ...
                <div className="google-button-container">
                    ...
                    {action === 'Login' && <GoogleButton  onClick={handleGoogleLogin} style={{ width: '250px', height: '46px' }}/>}
                </div>
            </div>
        </form>
    );
